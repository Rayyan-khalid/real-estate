...
const Testimonials = () => {
  return (
    ...
    className='container mx-auto py-10 px-4 lg:px-32 w-full overflow-hidden' id='Testimonials'>
        ...
        <div className='flex flex-nowrap gap-6 overflow-x-auto px-4 scrollbar-hide'>
            {testimonialsData.map((testimonial,index)=>(
                <div key={index} className='min-w-[300px] max-w-[340px] flex-shrink-0 border shadow-lg rounded-xl px-6 py-8 bg-white text-center'>
