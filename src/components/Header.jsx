...
{/* We apply Framer Motion Animation in the div section and remove the div */}
    <motion.div 
    ...
    className='container text-center mx-auto py-4 px-6 md:px-20
        lg:px-32 text-white'>
        <h2 className='text-5xl sm:text-6xl md:text-[62px]
            inline-block max-w-3xl font-semibold pt-20'
            >Explore homes that <br />fit your dreams</h2>
